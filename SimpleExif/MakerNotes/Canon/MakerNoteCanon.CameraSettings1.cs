    ...
    internal partial class MakerNoteCanon : MakerNote
    {
        private string ParseCameraSettings1Value(int tag, int value) {
            ...
            switch (tag) {
                ...
                case 2: { //SelfTimer
                        ushort v = Tools.Calc.IntToUShort(value);
                        if (v / 10 == 0) {
                            ret = "Off";
                        }
                        else {
                ...
                case 10: { //CanonImageSize
                        short v = Tools.Calc.IntToShort(value);
                        switch (v) {
                ...
                case 26: //MaxAperture
                case 27: {//MinAperture
                        ret = Tools.Misc.GetAPEXFNumber(value, 32);// string.Format("{0:0.0}", Math.Pow(Math.Sqrt(2), (double)value / (double)32));
                ...
                case 29: {//FlashBits
                        ret = string.Empty;
                        string by = Tools.String.FillChar(Convert.ToString(value, 2), 16, "0");
                        int idx = 0;
                ...
                case 35: { //DisplayAperture
                        ...
                        switch (v) {
                            ...
                            default: ret = Tools.Misc.GetAPEXFNumber(v, 32); break;
                        }
                        break;
                    }
